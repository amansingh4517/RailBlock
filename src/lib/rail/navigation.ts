  ...
  CONTROL: [
    {
      ...
      path: "/control",
      icon: Gauge,
      description: "Live operational dashboard and immediate attention items",
    },
    {
      id: "approvals",
      ...
      icon: CheckCircle2,
      description: "Central action center for departmental demands and proposed blocks",
    },
    {
      id: "plan",
      label: "Block Plan",
      ...
      icon: CalendarDays,
      description: "Weekly/monthly schedules and corridor optimization engine",
    },
    {
      id: "reports",
      label: "Reports",
      ...
      icon: BarChart3,
      description: "Schedule performance, asset availability, and downtime reduction",
    },
  ],
  ADMIN: [
    {
